...
const Register = () => {
	...
	const handleSubmit = async (event) => {
		...
		try {
			...
			addAlert('Registered account successfully!', 'success')
			...
			>
				<Box sx={{ p: 4, textAlign: 'center' }}>
					...
					<Typography variant="body2" sx={{ color: '#94a3b8', mt: 0.5 }}>
						Set up your credentials for encrypted cloud access
					</Typography>
					<Chip
						icon={<ShieldIcon sx={{ fontSize: '13px !important', color: '#10b981 !important' }} />}
						label="AES-256-GCM Protection"
						size="small"
				...
				<Box component="form" onSubmit={handleSubmit} sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 2.5 }}>
					...
					<Box sx={{ textAlign: 'center', mt: 1 }}>
						<A href="/login" style={{ color: '#818cf8', 'text-decoration': 'none', 'font-size': '14px', 'font-weight': 600 }}>
